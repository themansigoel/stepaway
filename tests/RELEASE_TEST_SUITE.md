...
### 3. Run Human-Like Master End-to-End Suite (`--e2e-human-test`)
```bash
# In terminal foreground with real-time logs:
...
```
*Navigates all 7 sidebar tabs, tests all 6 sub-tabs, drags short/long sliders, steppers, toggles safeguards, creates/deletes exercises, sets wellness reminders, displays heatmap streaks, tests focus mode, HomeKit/Hue smart lighting, and triggers all 4 full-screen HUD overlays with real user pacing.*
